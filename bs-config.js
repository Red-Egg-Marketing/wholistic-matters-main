...
const siteUrl = 'https://dwholisticmatt.wpenginepowered.com/', // example `http://site-url.com/`
	themeName = 'wholisticmatters'; // example `project-name`. Theme name should not have spaces!!!
